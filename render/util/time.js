...
function monthUpdate(arrName) {
  return function(d, v, i18n) {
    let index = i18n[arrName].indexOf(
...
fecha.toDate = function(v) {
  return fecha.format(v, "yyyy-MM-dd");
};

fecha.toTime = function(v) {
  return fecha.format(v, "yyyy-MM-dd HH:mm");
};
export const Time = fecha;
