  ...
  <div class="tree-panel">
    <div class="tree-header">
      <div class="tree-header-left">
        ...
        <Button @click="onTreeEdit" icon="md-create" :type="editing ? 'primary' : 'default'" :ghost="editing" size="small"></Button>
    ...
    >
      <template v-slot:name="{ data }">
        ...
        />
        {{ ($main.storage.folderListMode = 'list' ? data.path : data.path && data.path.split(/\/|\\/).pop()) }}
      </template>
    </CommonTree>
